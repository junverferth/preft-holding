...
;stop
;l1=where(tube.x[0,*] ge (tube.x[0,0]+zbot) and tube.x[0,*] le (tube.x[0,tube.n/2]-ztop))
;m=where(tube.x[0,*] ge (tube.x[0,tube.n/2]-ztop) and tube.x[0,*] le (tube.x[0,tube.n/2]+ztop))
;r1=where(tube.x[0,*] le (tube.x[0,-1]-zbot) and tube.x[0,*] ge (tube.x[0,tube.n/2]+ztop))
;l2=tube.x[0,max(l1)]-tube.x[0,min(l1)]
;r2=tube.x[0,min(r1)]-tube.x[0,max(r1)]
;tube.b=b0
;tube.b[l1]=b0*(1-rec_ang*sin((tube.x[0,l1]-tube.x[0,l1[0]])*!pi/2.0/l2)^2)
;tube.b[r1]=b0*(1-rec_ang*sin((tube.x[0,r1[-1]]-tube.x[0,r1])*!pi/2.0/r2)^2)
;tube.b[m]=tube.b[r1[0]]
;tube.db[0,l1]=-b0*rec_ang*sin((tube.x[0,l1]-tube.x[0,l1[0]])*!pi/2.0/l2)*cos((tube.x[0,l1]-tube.x[0,l1[0]])*!pi/2.0/l2)*!pi/l2
;tube.db[0,r1]=b0*rec_ang*sin((tube.x[0,r1[-1]]-tube.x[0,r1])*!pi/2.0/r2)*cos((tube.x[0,r1[-1]]-tube.x[0,r1])*!pi/2.0/r2)*!pi/r2
;tube.db[0,m]=0.0
...
; -----------------------------
pro init_expanse,expansion,rec_ang_,b0_,peak,base,ztop_,zbot_
  common cs, rec_ang,ztop,zbot,b0
common fieldshape,fieldlen,fieldstr,fieldderiv,cs_scale
